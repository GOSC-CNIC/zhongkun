"""
Django settings for cloudverse project.
...
LOGGING_FILES_DIR = Path('/var/log/cloudverse')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': LOGGING_FILES_DIR.joinpath('cloudverse.log'),
            'formatter': 'verbose',
...
CRONTABJOBS = [
    ('task1_metering', '0 9 * * *',
     'python3 /home/uwsgi/cloudverse/metering/timedelta_metering.py >> /var/log/cloudverse/task_metering.log'),
    ('task2_bkt_monthly', '0 12 28 * *',
     'python3 /home/uwsgi/cloudverse/scripts/run_bucket_monthly_stats.py',),
    ('task3_monthly_report', '0 17 28 * *',
     'python3 /home/uwsgi/cloudverse/scripts/run_generate_and_email_month_report.py >> /var/log/cloudverse/task_monthly_report.log'),
    ('task4_logsite_timecount', '*/1 * * * *',
     'python3 /home/uwsgi/cloudverse/scripts/run_log_site_req_num.py >> /var/log/cloudverse/task_logsite_timecount.log'),
    ('task5_req_num', '0 */1 * * *',
     'python3 /home/uwsgi/cloudverse/scripts/update_service_req_num.py >> /var/log/cloudverse/task_update_req_num.log')
]
