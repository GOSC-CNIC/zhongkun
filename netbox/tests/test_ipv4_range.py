...
class IPv4RangeTests(MyAPITransactionTestCase):
    ...
    def test_list_ipv4_ranges(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-list')
    ...
    def test_update_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-detail', kwargs={'id': 'test'})
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-detail', kwargs={'id': ip_range1.id})
        response = self.client.put(base_url, data={
            'name': 'test', 'start_address': '127.0.1.1', 'end_address': '127.0.1.255', 'mask_len': 24,
            'asn': 88, 'admin_remark': 'remark test'
        })
        ...
        # ok
        base_url = reverse('netbox-api:ipam-ipv4range-detail', kwargs={'id': ip_range2.id})
        response = self.client.put(base_url, data={
    ...
    def test_split_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-split', kwargs={'id': 'test'})
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-split', kwargs={'id': ip_range1.id})
        ...
        self.assertEqual(IPv4RangeRecord.objects.count(), 1)
        self.assertEqual(IPv4Range.objects.count(), 5)
        base_url = reverse('netbox-api:ipam-ipv4range-split', kwargs={'id': ip_range2.id})
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-split', kwargs={'id': ip_range3.id})
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-split', kwargs={'id': ip_range4.id})
    ...
    def test_merge_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-merge')
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
    ...
    def test_recover_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-recover', kwargs={'id': 'test'})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        self.assertEqual(IPv4Range.objects.count(), 2)
        self.assertEqual(IPv4RangeRecord.objects.count(), 0)
        base_url = reverse('netbox-api:ipam-ipv4range-recover', kwargs={'id': ip_range1.id})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 200)
        self.assertKeysIn([
            'id', 'name', 'status', 'creation_time', 'update_time', 'assigned_time', 'admin_remark',
        ...
        # ok
        base_url = reverse('netbox-api:ipam-ipv4range-recover', kwargs={'id': ip_range2.id})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 200)
        self.assertKeysIn([
            'id', 'name', 'status', 'creation_time', 'update_time', 'assigned_time', 'admin_remark',
    ...
    def test_reserve_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-reserve', kwargs={'id': 'test'})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        # status
        base_url = reverse('netbox-api:ipam-ipv4range-reserve', kwargs={'id': ip_range1.id})
        query = parse.urlencode(query={'org_virt_obj_id': virt_obj1.id})
        response = self.client.post(f'{base_url}?{query}')
        self.assertErrorResponse(status_code=409, code='Conflict', response=response)
        ...
        # ok
        base_url = reverse('netbox-api:ipam-ipv4range-reserve', kwargs={'id': ip_range2.id})
        query = parse.urlencode(query={'org_virt_obj_id': virt_obj1.id})
        response = self.client.post(f'{base_url}?{query}')
        self.assertErrorResponse(status_code=409, code='Conflict', response=response)
    ...
    def test_assign_ipv4_range(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-assign', kwargs={'id': 'test'})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        # 只能分配给预留机构二级对象
        base_url = reverse('netbox-api:ipam-ipv4range-assign', kwargs={'id': ip_range2.id})
        ...
        # ip_range1
        # status
        base_url = reverse('netbox-api:ipam-ipv4range-assign', kwargs={'id': ip_range1.id})
        query = parse.urlencode(query={'org_virt_obj_id': virt_obj2.id})
        response = self.client.post(f'{base_url}?{query}')
        self.assertErrorResponse(status_code=409, code='Conflict', response=response)
    ...
    def test_remark(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-remark', kwargs={'id': 'test'})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        # not org admin
        base_url = reverse('netbox-api:ipam-ipv4range-remark', kwargs={'id': ip_range1.id})
        query = parse.urlencode(query={'remark': 'notfound'})
        response = self.client.post(f'{base_url}?{query}')
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)
        ...
        # status not assigned
        base_url = reverse('netbox-api:ipam-ipv4range-remark', kwargs={'id': ip_range2.id})
        query = parse.urlencode(query={'remark': 'notfound'})
        response = self.client.post(f'{base_url}?{query}')
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)
    ...
    def test_split_to_plan(self):
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-plan-split', kwargs={'id': 'test'})
        response = self.client.post(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-plan-split', kwargs={'id': ip_range1.id})
        # assigned
        response = self.client.post(base_url, data={
            'sub_ranges': [
                {'start_address': 1, 'end_address': 6, 'prefix': 24},
        ...
        self.assertEqual(IPv4RangeRecord.objects.count(), 1)
        self.assertEqual(IPv4Range.objects.count(), 5)
        base_url = reverse('netbox-api:ipam-ipv4range-plan-split', kwargs={'id': ip_range2.id})
        response = self.client.post(base_url, data={
            'sub_ranges': [
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-plan-split', kwargs={'id': ip_range3.id})
        response = self.client.post(base_url, data={
            'sub_ranges': [
        ...
        base_url = reverse('netbox-api:ipam-ipv4range-plan-split', kwargs={'id': ip_range4.id})
        self.assertEqual(IPv4RangeRecord.objects.count(), 3)
        self.assertEqual(IPv4Range.objects.count(), 9)
        response = self.client.post(base_url, data={
            'sub_ranges': [
