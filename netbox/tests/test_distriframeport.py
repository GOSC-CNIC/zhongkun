...
from netbox.managers.common import OrgVirtualObjectManager, NetBoxUserRoleWrapper
from netbox.managers.link_mgrs import DistriFrameManager, LinkManager
from netbox.models import DistriFramePort, Link
...
class DistriFramePortTests(MyAPITransactionTestCase):
    ...
    def test_list_distriframeport(self):
        # user role 
        base_url = reverse('netbox-api:link-distriframeport-list')
