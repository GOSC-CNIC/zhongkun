# Generated by Django 4.2.5 on 2023-10-27 02:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='connectorbox',
            options={'ordering': ('-update_time',), 'verbose_name': '光缆接头盒', 'verbose_name_plural': '光缆接头盒'},
        ),
        migrations.AlterModelOptions(
            name='distributionframe',
            options={'ordering': ('-update_time',), 'verbose_name': '配线架', 'verbose_name_plural': '配线架'},
        ),
        migrations.AlterModelOptions(
            name='elementlink',
            options={'ordering': ('-update_time',), 'verbose_name': '链路', 'verbose_name_plural': '链路'},
        ),
        migrations.AlterModelOptions(
            name='fibercable',
            options={'ordering': ('-update_time',), 'verbose_name': '光缆', 'verbose_name_plural': '光缆'},
        ),
        migrations.AlterModelOptions(
            name='opticalfiber',
            options={'ordering': ('sequence',), 'verbose_name': '光纤', 'verbose_name_plural': '光纤'},
        ),
        migrations.AlterModelOptions(
            name='task',
            options={'ordering': ('-update_time',), 'verbose_name': '业务', 'verbose_name_plural': '业务'},
        ),
