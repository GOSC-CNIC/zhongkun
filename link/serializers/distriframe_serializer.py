...
class DistriFrameSerializer(serializers.Serializer):
    ...
    row_count = serializers.IntegerField(label=_('行数'), validators=(MinValueValidator(0),), allow_null=False, required=True)
    col_count = serializers.IntegerField(label=_('列数'), validators=(MinValueValidator(0),), allow_null=False, required=True)
