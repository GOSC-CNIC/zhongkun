...
class DistriFramePortSerializer(ElementBaseSerializer):
    ...
    row = serializers.IntegerField(label=_('行号'), validators=(MinValueValidator(0),), allow_null=False, required=True)
    col = serializers.IntegerField(label=_('列号'), validators=(MinValueValidator(0),), allow_null=False, required=True)
