...
from ..managers import UserIpamRoleWrapper, IPv4RangeManager, IPv4RangeRecordManager
from ..models import ASN, OrgVirtualObject, IPv4Range, IPv4RangeRecord, IPRangeItem
...
class IPv4RangeRecordTests(MyAPITransactionTestCase):
    ...
    def test_list(self):
        ...
        base_url = reverse('ipam-api:record-ipv4range-list')
