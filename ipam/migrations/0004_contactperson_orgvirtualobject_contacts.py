...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '机构二级对象联系人',
                'verbose_name_plural': '机构二级对象联系人',
        ...
        migrations.AddField(
            ...
            name='contacts',
            field=models.ManyToManyField(blank=True, db_constraint=False, db_table='ipam_org_obj_contacts', related_name='+', to='ipam.contactperson', verbose_name='机构二级对象联系人'),
        ),
    ]
