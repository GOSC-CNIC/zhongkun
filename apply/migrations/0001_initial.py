    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vo_id', models.CharField(max_length=36, verbose_name='项目组id')),
                ('vo_name', models.CharField(max_length=128, verbose_name='项目组名称')),
                ...
                ('approver', models.CharField(max_length=128, verbose_name='审批人')),
                ('reject_reason', models.CharField(default='', max_length=255, verbose_name='拒绝原因')),
