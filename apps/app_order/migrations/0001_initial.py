    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource_type', models.CharField(choices=[('vm', '云主机'), ('disk', '云硬盘'), ('bucket', '存储桶'), ('scan', '安全扫描'), ('vm_snapshot', '云主机快照')], default='vm', max_length=16, verbose_name='资源类型')),
                ...
                ('start_time', models.DateTimeField(blank=True, default=None, help_text='包年包月订单订购资源的时间段起始时间', null=True, verbose_name='订购起始时间')),
                ('end_time', models.DateTimeField(blank=True, default=None, help_text='包年包月订单订购资源的时间段截止时间', null=True, verbose_name='订购截止时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(blank=True, editable=False, max_length=36, primary_key=True, serialize=False, verbose_name='ID')),
                ('resource_type', models.CharField(choices=[('vm', '云主机'), ('disk', '云硬盘'), ('bucket', '存储桶'), ('scan', '安全扫描'), ('vm_snapshot', '云主机快照')], max_length=16, verbose_name='资源类型')),
