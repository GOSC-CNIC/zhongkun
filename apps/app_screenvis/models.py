...
class ServerServiceTimedStats(BaseTimed):
    ...
    pri_ip_count = models.IntegerField(verbose_name=_('私IP总数'), blank=True, default=0)
    pri_ip_used_count = models.IntegerField(verbose_name=_('已用私网IP数'), blank=True, default=0)
