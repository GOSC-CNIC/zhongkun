# Generated by Django 4.2.5 on 2023-11-02 07:32
...
def service_org_data_center(apps, schema_editor):
    ...
    for sv_dict in services:
        ...
        sv = ObjectsService(id=sv_dict['id'])
        sv.org_data_center_id = odc.id
        sv.save(update_fields=['org_data_center_id'])
        ok_count += 1

    print(f'Changed storage service ForeignKey to OrgDataCenter OK，ok={ok_count}, skip={skip_count}')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('storage', '0003_objectsservice_org_data_center'),
    ]

    operations = [
        migrations.RunPython(service_org_data_center, reverse_code=do_nothing),
    ]
