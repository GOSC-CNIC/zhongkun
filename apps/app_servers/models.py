...
class ServiceConfig(BaseService):
    ...
    server_managed = models.IntegerField(verbose_name=_('本服务在管云主机数'), default=0, help_text=_('服务单元在本服务中管理的云主机数'))
    server_total = models.IntegerField(verbose_name=_('服务单元云主机总数'), default=0, help_text=_('服务单元中总的云主机数'))
    server_update_time = models.DateTimeField(verbose_name=_('云主机数更新时间'), null=True, blank=True, default=None)
...
class ServerBase(models.Model):
    ...
    ipv4 = models.CharField(max_length=128, verbose_name='IPV4', blank=True, default='')
    public_ip = models.BooleanField(default=True, verbose_name=_('公/私网'), help_text=_('选中为公网'))
    image = models.CharField(max_length=255, verbose_name=_('镜像系统名称'), blank=True, default='')
    image_id = models.CharField(max_length=64, verbose_name=_('镜像系统ID'), blank=True, default='')
    img_sys_type = models.CharField(max_length=32, verbose_name=_('镜像系统类型'), blank=True, default='')
    img_sys_arch = models.CharField(max_length=32, verbose_name=_('镜像系统架构'), blank=True, default='')
    img_release = models.CharField(max_length=32, verbose_name=_('镜像系统发行版'), blank=True, default='')
    img_release_version = models.CharField(max_length=32, verbose_name=_('镜像系统发行版版本'), blank=True, default='')
    image_desc = models.CharField(max_length=255, verbose_name=_('镜像系统描述'), blank=True, default='')
    default_user = models.CharField(max_length=64, verbose_name=_('默认登录用户名'), blank=True, default='')
