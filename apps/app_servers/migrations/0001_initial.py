    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vcpus', models.IntegerField(default=0, verbose_name='虚拟CPU数')),
                ('ram', models.IntegerField(default=0, verbose_name='内存GiB')),
                ('ipv4', models.CharField(blank=True, default='', max_length=128, verbose_name='IPV4')),
                ('public_ip', models.BooleanField(default=True, help_text='选中为公网', verbose_name='公/私网')),
                ('image', models.CharField(blank=True, default='', max_length=255, verbose_name='镜像系统名称')),
                ('image_id', models.CharField(blank=True, default='', max_length=64, verbose_name='镜像系统ID')),
                ('image_desc', models.CharField(blank=True, default='', max_length=255, verbose_name='镜像系统描述')),
                ('default_user', models.CharField(blank=True, default='', max_length=64, verbose_name='默认登录用户名')),
