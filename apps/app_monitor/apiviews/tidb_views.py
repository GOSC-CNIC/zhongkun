...
from apps.app_monitor.managers.tidb import TiDBQueryChoices, TiDBQueryV2Choices
from apps.app_monitor.handlers.monitor_tidb import MonitorTiDBQueryHandler
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            ...
            openapi.Parameter(
                ...
                enum=TiDBQueryV2Choices.values
            )
        ],
        responses={
            200: ''
