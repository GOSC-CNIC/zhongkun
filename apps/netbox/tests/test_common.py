...
class NetBoxUserRoleTests(MyAPITransactionTestCase):
    ...
    def test_list_user_role(self):
        ...
        base_url = reverse('netbox-api:netbox-userrole-list')
        ...
        self.assertKeysIn(
            ['id', 'user', 'is_ipam_admin', 'is_ipam_readonly', 'is_link_admin', 'is_link_readonly',
             'creation_time', 'update_time', 'organizations'], response.data)
...
class OrgObjTests(MyAPITransactionTestCase):
    ...
    def test_create(self):
        ...
        base_url = reverse('netbox-api:org-obj-list')
    ...
    def test_list(self):
        ...
        u1_role_wrapper.set_link_readonly(False)
        u1_role_wrapper.set_link_admin(True)
        response = self.client.get(base_url)
        self.assertEqual(response.status_code, 200)
        self.assertKeysIn(['count', 'page_num', 'page_size', 'results'], response.data)
    ...
    def test_update(self):
        ...
        base_url = reverse('netbox-api:org-obj-detail', kwargs={'id': org_obj.id})
        ...
        base_url = reverse('netbox-api:org-obj-detail', kwargs={'id': 'notfound'})
    ...
    def test_detail(self):
        ...
        # TargetNotExist
        base_url = reverse('netbox-api:org-obj-detail', kwargs={'id': 'notf'})
        response = self.client.get(base_url)
        self.assertErrorResponse(status_code=404, code='TargetNotExist', response=response)
    ...
    def test_add_contacts(self):
        ...
        url = reverse('netbox-api:org-obj-add-contacts', kwargs={'id': 'notf'})
        ...
        u1_roler = NetBoxUserRoleWrapper(user=self.user1)
        u1_roler.user_role = u1_roler.get_or_create_user_role()
        u1_roler.user_role.organizations.add(org1)
        response = self.client.post(url, data={'contact_ids': ['test']})
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)

        u1_roler.set_ipam_readonly(True)
        response = self.client.post(url, data={'contact_ids': ['test']})
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)

        u1_roler.set_ipam_admin(True)
        ...
        # contacts not exist
        url = reverse('netbox-api:org-obj-add-contacts', kwargs={'id': org_obj.id})
        response = self.client.post(url, data={'contact_ids': ['test']})
        self.assertErrorResponse(status_code=400, code='InvalidArgument', response=response)
        ...
        # test link
        u1_roler.set_ipam_admin(False)
        response = self.client.post(url, data={'contact_ids': [cp1.id, cp2.id, cp3.id]})
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)

        u1_roler.set_link_readonly(True)
        response = self.client.post(url, data={'contact_ids': [cp1.id, cp2.id, cp3.id]})
        self.assertErrorResponse(status_code=403, code='AccessDenied', response=response)

        u1_roler.set_link_admin(True)
    ...
    def test_remove_contacts(self):
        ...
        url = reverse('netbox-api:org-obj-remove-contacts', kwargs={'id': 'notf'})
        response = self.client.post(url)
        self.assertErrorResponse(status_code=401, code='NotAuthenticated', response=response)
        ...
        # contacts not exist
        url = reverse('netbox-api:org-obj-remove-contacts', kwargs={'id': org_obj.id})
        response = self.client.post(url, data={'contact_ids': ['test']})
        self.assertErrorResponse(status_code=400, code='InvalidArgument', response=response)
...
class ContactsTests(MyAPITransactionTestCase):
    ...
    def test_update(self):
        ...
        base_url = reverse('netbox-api:contacts-detail', kwargs={'id': cp.id})
        response = self.client.put(base_url)
        self.assertEqual(response.status_code, 401)
        ...
        base_url = reverse('netbox-api:contacts-detail', kwargs={'id': 'notf'})
        response = self.client.put(base_url, data={
            'name': '张三', 'telephone': '6', 'email': 'test123@cnic.cn', 'address': 'beijing66', 'remarks': 'test88'})
        self.assertErrorResponse(status_code=404, code='TargetNotExist', response=response)
