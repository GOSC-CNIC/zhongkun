...
from netbox.models import OpticalFiber, ConnectorBox, DistriFramePort, LeaseLine, Element
from netbox.managers.link_mgrs import FiberCableManager, DistriFrameManager, ConnectorBoxManager, LeaseLineManager
