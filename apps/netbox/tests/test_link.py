...
from netbox.managers.link_mgrs import (
    LeaseLineManager, FiberCableManager, DistriFrameManager, ConnectorBoxManager, LinkManager
)
from netbox.models import Link, OpticalFiber, DistriFramePort, ElementLink
...
class LinkTests(MyAPITransactionTestCase):
    ...
    def test_list_link(self):
        ...
        link2 = LinkManager.create_link(
            ...
            user="空天院-中国遥感卫星地面站",
            endpoint_a="空天院新技术园区B座A301机房，王萌13811835852",
            endpoint_z="海淀区丰贤东路5号，中国资源卫星应用中心一期楼三层机房A301，吴郡13811754165，光缆施工联系沈老"
                       "师13810428468，布跳线联系徐工13521066224",
            bandwidth=None,
            description="中国遥感卫星地面站至中国资源卫星应用中心高分项目专线（裸纤）",
            line_type="科技云科技专线",
            business_person="周建虎",
        ...
        # user role 
        base_url = reverse('netbox-api:link-link-list')
    ...
    def test_retrieve_link(self):
        ...
        link = LinkManager.create_link(
            ...
            user="空天院-中国遥感卫星地面站",
            endpoint_a="空天院新技术园区B座A301机房，王萌13811835852",
            endpoint_z="海淀区丰贤东路5号，中国资源卫星应用中心一期楼三层机房A301，吴郡13811754165，光缆施工联系沈老师13810428468，"
                       "布跳线联系徐工13521066224",
            bandwidth=0,
            description="中国遥感卫星地面站至中国资源卫星应用中心高分项目专线（裸纤）",
            line_type="科技云科技专线",
        ...
        # user role
        base_url = reverse('netbox-api:link-link-detail', kwargs={'id': link.id})
        response = self.client.get(base_url)
        self.assertEqual(response.status_code, 401)
        self.client.force_login(self.user1)
        response = self.client.get(base_url)
        ...
        # element not exist
        base_url = reverse('netbox-api:link-link-detail', kwargs={'id': 'asd'})
        response = self.client.get(base_url)
    ...
    def test_creat_link(self):
        ...
        data = json.dumps({
            ...
            "user": "空天院-中国遥感卫星地面站",
            "endpoint_a": "空天院新技术园区B座A301机房，王萌13811835852",
            "endpoint_z": "海淀区丰贤东路5号，中国资源卫星应用中心一期楼三层机房A301，吴郡13811754165，光缆施工联系"
                          "沈老师13810428468，布跳线联系徐工13521066224",
            "description": "中国遥感卫星地面站至中国资源卫星应用中心高分项目专线（裸纤）",
            "line_type": "科技云科技专线",
            "business_person": "周建虎",
            "build_person": "胡亮亮、王振伟",
        ...
        data = json.dumps({
            ...
            "user": "空天院-中国遥感卫星地面站",
            "endpoint_a": "空天院新技术园区B座A301机房，王萌13811835852",
            "endpoint_z": "海淀区丰贤东路5号，中国资源卫星应用中心一期楼三层机房A301，吴郡13811754165，光缆施工联"
                          "系沈老师13810428468，布跳线联系徐工13521066224",
            "description": "中国遥感卫星地面站至中国资源卫星应用中心高分项目专线（裸纤）",
            "line_type": "科技云科技专线",
            "business_person": "周建虎",
            "build_person": "胡亮亮、王振伟",
