...
class IPv4Address(IPAddressBase):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name
        constraints = [
            models.UniqueConstraint(fields=('ip_address',), name='netbox_uniq_ipv4_addr')
        ]
...
class IPv6Range(IPRangeBase):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name
        indexes = [
            models.Index(fields=['start_address'], name='netbox_idx_ipv6rg_start_addr'),
            models.Index(fields=['end_address'], name='netbox_idx_ipv6rg_end_addr')
        ]
...
class IPv6Address(IPAddressBase):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name
        constraints = [
            models.UniqueConstraint(fields=('ip_address',), name='netbox_uniq_ipv6_addr')
        ]
