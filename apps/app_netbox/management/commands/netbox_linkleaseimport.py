...
from apps.app_netbox.models import LeaseLine
from apps.app_netbox.managers.link_mgrs import LeaseLineManager


class Command(BaseCommand):
    help = """
    manage.py netbox_linkleaseimport --file="/home/x.csv"; 
    """
