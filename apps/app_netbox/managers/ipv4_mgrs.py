...
from apps.app_netbox.models import (
    IPv4Range, OrgVirtualObject, ASN, ipv4_str_to_int, IPv4RangeRecord,
    IPRangeItem, IPRangeIntItem, IPv4Address
)
from .common import NetBoxUserRoleWrapper
...
class IPv4RangeManager:
    ...
    def get_user_queryset(self, org_id: str, asn: int, ipv4_int: int, search: str, user_role: NetBoxUserRoleWrapper):
