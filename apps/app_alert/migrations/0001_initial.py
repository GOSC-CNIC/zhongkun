# Generated by Django 4.2.9 on 2024-04-12 03:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.PositiveIntegerField(db_index=True, null=True, verbose_name='告警开始时间')),
                ('end', models.PositiveIntegerField(db_index=True, null=True, verbose_name='告警结束时间')),
            ],
            options={
                'verbose_name': '告警生命周期',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.PositiveIntegerField(db_index=True, verbose_name='告警开始时间')),
                ('end', models.PositiveIntegerField(db_index=True, null=True, verbose_name='告警结束时间')),
                ('count', models.PositiveIntegerField(default=1, verbose_name='累加条数')),
                ('first_notification', models.PositiveIntegerField(null=True, verbose_name='首次通知时间')),
                ('last_notification', models.PositiveIntegerField(null=True, verbose_name='上次通知时间')),
                ('creation', models.PositiveIntegerField(null=True, verbose_name='创建时间')),
                ('modification', models.PositiveIntegerField(null=True, verbose_name='更新时间')),
            ],
            options={
                'verbose_name': '进行中告警',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(blank=True, editable=False, max_length=36, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(max_length=25, unique=True, verbose_name='ipv4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('无需处理', '无需处理'), ('已完成', '已完成'), ('误报', '误报')], default=False, max_length=10, verbose_name='状态')),
