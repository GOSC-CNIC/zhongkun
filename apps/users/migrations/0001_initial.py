    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[
                    ('year', '年度报表'), ('month', '月度报表'), ('ticket', '工单通知'), ('coupon', '资源券通知'),
                    ('res-exp', '资源过期通知'), ('arrear', '欠费通知'), ('api', 'API请求'), ('ops', '服务维护通知'),
                    ('other', '其他')
                ], default='other', max_length=16, verbose_name='标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.JSONField(default=dict, help_text="角色选项(可多选)，['ordinary', 'federal-admin']", verbose_name='角色')),
