    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_original_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='云主机计费金额')),
                ('server_payable_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='云主机按量应付金额')),
                ('server_postpaid_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='云主机按量后付费金额')),
                ('server_prepaid_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='云主机订购预付费金额')),
                ...
                ('storage_original_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='存储桶计费金额')),
                ('storage_payable_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='存储桶按量应付金额')),
                ('storage_postpaid_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='存储桶按量后付费金额')),
