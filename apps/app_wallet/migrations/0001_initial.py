    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(blank=True, editable=False, max_length=36, primary_key=True, serialize=False, verbose_name='ID')),
                ('creation_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('amounts', models.DecimalField(decimal_places=2, help_text='正退款，负扣款', max_digits=10, verbose_name='金额')),
                ('before_payment', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='交易前余额')),
                ('after_payment', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='交易后余额')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('vms-server', '云服务器'), ('vms-object', '对象存储'), ('vms-monitor', '监控'), ('high-cloud', '高等级云'), ('hpc', '高性能计算'), ('scan', '安全扫描'), ('other', '其他')], default='other', max_length=16, verbose_name='服务类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amounts', models.DecimalField(decimal_places=2, help_text='负数', max_digits=10, verbose_name='金额')),
                ('coupon_amount', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='资源券或者抵扣金额，负数', max_digits=10, verbose_name='券金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amounts', models.DecimalField(decimal_places=2, help_text='正数', max_digits=10, verbose_name='退款对应的交易订单总金额')),
                ('refund_amounts', models.DecimalField(decimal_places=2, help_text='正数', max_digits=10, verbose_name='申请退款金额')),
                ('real_refund', models.DecimalField(decimal_places=2, help_text='正数', max_digits=10, verbose_name='实际退款金额')),
                ('coupon_refund', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='资源券或者优惠抵扣金额，正数', max_digits=10, verbose_name='资源券退款金额')),
                ('creation_time', models.DateTimeField(verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_amounts', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='余额+券金额，正负数(+-)', max_digits=10, verbose_name='交易总金额')),
                ('amounts', models.DecimalField(decimal_places=2, help_text='16.66, -8.88', max_digits=10, verbose_name='金额')),
                ('coupon_amount', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='资源券或者抵扣金额，正负数(+-)', max_digits=10, verbose_name='券金额')),
