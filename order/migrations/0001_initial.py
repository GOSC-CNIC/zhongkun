    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('unknown', '未知'), ('balance', '余额'), ('cashcoupon', '代金卷'), ('mixed', '混合支付')], default='unknown', max_length=16, verbose_name='付款方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vm_pub_ip', models.DecimalField(decimal_places=5, help_text='每个公网IP每小时的价格', max_digits=10, validators=[django.core.validators.MinValueValidator(0)], verbose_name='每公网IP每小时')),
