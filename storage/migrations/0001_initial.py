    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='object_service_set', to='service.datacenter', verbose_name='数据中心')),
                ('users', models.ManyToManyField(blank=True, related_name='object_service_set', to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='storage_quotas', to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '存储配额',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bucket_archive_set', to='storage.objectsservice', verbose_name='所属服务')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bucket_archive_set', to=settings.AUTH_USER_MODEL, verbose_name='所属用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='bucket_set', to='storage.objectsservice', verbose_name='所属服务')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bucket_set', to=settings.AUTH_USER_MODEL, verbose_name='所属用户')),
            ],
            options={
                'verbose_name': '存储桶',
